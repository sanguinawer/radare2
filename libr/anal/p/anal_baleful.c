	...
	switch (buf[0]) {
	 case 0:
      ...
      case 11:
		...
		op->size = 3;
		break;	
		//v15 = vmMemoryBase[vIP + 1];
        //v16_1 = VM_REG[vmMemoryBase[vIP + 2]];
        //vIP += 3;
        //VM_REG[v15] = v16_1 == 0;
        //v14 = VM_REG[v15];
      ...
      case 28://0x1c
		...
		break;
        //v15 = vmMemoryBase[vIP + 1];
        //v16_1 = vmMemoryBase[vIP + 2];
        //vIP += 3;
        //printf("%04x:  mov [r_%02x],r_%02x\n",vIP,v15,v16_1);
		//v8 = &vmMemoryBase[VM_REG[v15]]; 
        //*(_DWORD *)v8 = VM_REG[(signed int)v16_1];
        //v14 = *(_DWORD *)v8;
      case 30:
        p = buf + 1;
